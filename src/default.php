...
return [
	...
	'resource' => [
		...
		'fs' => [
			...
			'baseurl' => rtrim( env( 'ASSET_URL', url() ?: env( 'APP_URL' ) ), '/' ) . '/aimeos',
		],
		'fs-media' => [
			'adapter' => 'Standard',
			'tempdir' => storage_path( 'tmp' ),
		...
		'fs-mimeicon' => [
			...
			'baseurl' => rtrim( env( 'ASSET_URL', url() ?: env( 'APP_URL' ) ), '/' ) . '/vendor/shop/mimeicons',
		],
		'fs-theme' => [
			'adapter' => 'Standard',
			'tempdir' => storage_path( 'tmp' ),
			'basedir' => public_path( 'vendor/shop/themes' ),
			'baseurl' => rtrim( env( 'ASSET_URL', url() ?: env( 'APP_URL' ) ), '/' ) . '/vendor/shop/themes',
		],
		'fs-admin' => [
			'adapter' => 'Standard',
			'tempdir' => storage_path( 'tmp' ),
