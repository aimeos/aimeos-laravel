...
Note, that you can still use `utf8mb4_unicode_ci` as your default collation. `utf8mb4_bin` is required if you use Aimeos together with ElasticSearch because ElasticSearch creates IDs like aaaaa and àaaaA. So to offer a save default for all cases, `utf8mb4_unicode_ci` is recommended.
